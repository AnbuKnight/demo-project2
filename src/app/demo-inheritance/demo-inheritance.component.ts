...
@Component({
  selector: 'app-demo-inheritance',
  templateUrl: './demo-inheritance.component.html',
  styleUrls: ['./demo-inheritance.component.css']
})
export class DemoInheritanceComponent implements OnInit {
